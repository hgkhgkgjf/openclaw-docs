...
checks, see [npm shrinkwrap](/tutorials/gateway/security/shrinkwrap).
...
- [Plugin dependency resolution](/tutorials/plugins/dependency-resolution)
- [Plugin inventory](/tutorials/plugins/plugin-inventory)
- [Full release validation](/tutorials/reference/full-release-validation)
