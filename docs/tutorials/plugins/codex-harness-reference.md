...
| `codexPlugins`             | disabled                 | Native Codex plugin/app support for migrated source-installed curated plugins. See [Native Codex plugins](/tutorials/plugins/codex-native-plugins). |
| `computerUse`              | disabled                 | Codex Computer Use setup. See [Codex Computer Use](/tutorials/plugins/codex-computer-use).                                                          |
...
- [Codex harness](/tutorials/plugins/codex-harness)
- [Codex harness runtime](/tutorials/plugins/codex-harness-runtime)
- [Native Codex plugins](/tutorials/plugins/codex-native-plugins)
- [Codex Computer Use](/tutorials/plugins/codex-computer-use)
- [OpenAI provider](/tutorials/providers/openai)
- [Configuration reference](/tutorials/gateway/configuration-reference)
