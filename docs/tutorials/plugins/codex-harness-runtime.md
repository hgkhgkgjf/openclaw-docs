...
routing, start with [Codex harness](/tutorials/plugins/codex-harness). For config fields,
see [Codex harness reference](/tutorials/plugins/codex-harness-reference).
...
[Plugin permission requests](/tutorials/plugins/plugin-permission-requests).
...
instead of steering. See [Steering queue](/tutorials/concepts/queue-steering).
...
diagnostics export. See [Diagnostics export](/tutorials/gateway/diagnostics) for the
...
- [Codex harness reference](/tutorials/plugins/codex-harness-reference)
- [Native Codex plugins](/tutorials/plugins/codex-native-plugins)
- [Plugin hooks](/tutorials/plugins/hooks)
- [Agent harness plugins](/tutorials/plugins/sdk-agent-harness)
- [Diagnostics export](/tutorials/gateway/diagnostics)
- [Trajectory export](/tutorials/tools/trajectory)
