...
If your config still contains `channels.bluebubbles`, migrate it to `channels.imessage`. The legacy `/channels/bluebubbles` docs URL redirects to [Coming from BlueBubbles](/tutorials/channels/imessage-from-bluebubbles), which has the full config translation table and cutover checklist.
...
- [Coming from BlueBubbles](/tutorials/channels/imessage-from-bluebubbles)
- [iMessage](/tutorials/channels/imessage)
- [Configuration reference - iMessage](/tutorials/gateway/config-channels#imessage)
