...
::: info 说明
这是给 OpenClaw 核心开发者看的 contributor guide。
如果你是在写外部插件，先看 [Building plugins](/tutorials/plugins/building-plugins)。如果你要看更深的架构参考，再看 [Plugin internals](/tutorials/plugins/architecture)。
:::
