...
::: info 说明
For the short announcement and operator summary, see [BlueBubbles removal and the imsg iMessage path](/tutorials/reference/announcements-bluebubbles-imessage).
:::
