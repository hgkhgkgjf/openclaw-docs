...
Use this page after the base [Codex harness](/tutorials/plugins/codex-harness) is working.
...
- [Configuration reference](/tutorials/gateway/configuration-reference#codex-harness-plugin-config)
- [Migrate CLI](/tutorials/cli/migrate)
