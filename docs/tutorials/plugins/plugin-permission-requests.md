...
See [Advanced exec approvals](/tutorials/tools/exec-approvals-advanced#plugin-approval-forwarding)
...
See [Codex harness runtime](/tutorials/plugins/codex-harness-runtime#native-permissions-and-mcp-elicitations)
...
- [Plugin hooks](/tutorials/plugins/hooks#tool-call-policy)
- [Building plugins](/tutorials/plugins/building-plugins#registering-agent-tools)
- [Advanced exec approvals](/tutorials/tools/exec-approvals-advanced#plugin-approval-forwarding)
- [Gateway protocol](/tutorials/gateway/protocol)
- [Codex harness runtime](/tutorials/plugins/codex-harness-runtime#native-permissions-and-mcp-elicitations)
