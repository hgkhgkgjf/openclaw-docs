...
See [Full release validation](/tutorials/reference/full-release-validation) for the
...
see [Testing updates and plugins](/tutorials/help/testing-updates-plugins).
...
- [Development channels](/tutorials/installation/development-channels)
