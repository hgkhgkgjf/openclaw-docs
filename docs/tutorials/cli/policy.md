...
observed config. See [Agent-scoped policy overlays](/tutorials/plan/policy-agent-scoped-overlays).
...
- [Doctor lint mode](/tutorials/cli/doctor#lint-mode)
- [Path CLI](/tutorials/cli/path)
